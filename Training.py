...
Original file is located at
    https://colab.research.google.com/drive/1Q4JdgZkOLW3fbNBElggeZLwqxkSxwH0Z
"""
...
image=load_img("/content/Dataset/Test/test/1.jpg",target_size=(224,224))
predict_image(image)
plt.imshow(image)
plt.show()
...
Final_Predictions = pd.DataFrame({'Filename': filenames, 'Prediction': value})

Final_Predictions

Final_Predictions.to_csv('Final Predictions.csv')
